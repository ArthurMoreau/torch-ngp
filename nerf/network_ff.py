...
class NeRFWNetwork(NeRFRenderer):
    def __init__(self,
        ...
        # add apperance code
        self.in_dim_color += self.geo_feat_dim + 1 + self.in_channels_a # a manual fixing to make it 32, as done in nerf_network.h#178
    ...
    def forward(self, x, d, l_a, l_t):
        ...
        h = torch.cat([d, geo_feat, l_a, p], dim=-1)
    ...
    def color(self, x, d, l_a, l_t, mask=None, geo_feat=None, **kwargs):
        # x: [N, 3] in [-bound, bound]
